...
```{r}
# xen
xencolors <- sig_b_colors[,c(2,1,15)]
colnames(xencolors) <- c("target_id", "xen_gene_name", "xen_peptide_id")
...
## now full 2 xen
all <- sig_colors[,c(2,1,15)]
colnames(all) <- c("target_id", "all_gene_name", "all_peptide_id")
